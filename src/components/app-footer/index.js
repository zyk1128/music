...
import {FooterLeft,FooterRight, FooterWrap} from './style';


export default memo(function JustinAppFooter() {
  return (
    <FooterWrap>
      <div className="content wrap-v2">
        <FooterLeft>
          <p className="footerLinks-list">
            {
              footerLinks.map((item)=>{
                return (
                  <span key={item.title} className="footerLinks-item">
